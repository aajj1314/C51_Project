      ...
      000003 02 00 63         [24]  300 	ljmp	_main
                                    ...
                                    308 ;------------------------------------------------------------
                                    309 ;	src/main.c:2: void Delay(void)
                                    310 ;	-----------------------------------------
                                    311 ;	 function Delay
                                    312 ;	-----------------------------------------
      000062                        313 _Delay:
                           ...
                           000000   321 	ar0 = 0x00
                                    322 ;	src/main.c:7: }
      000062 22               [24]  323 	ret
                                    324 ;------------------------------------------------------------
                                    325 ;Allocation info for local variables in function 'main'
                                    326 ;------------------------------------------------------------
                                    327 ;	src/main.c:8: void main()
                                    328 ;	-----------------------------------------
                                    329 ;	 function main
                                    330 ;	-----------------------------------------
      000063                        331 _main:
                                    332 ;	src/main.c:10: P0 = 0x55;
      000063 75 80 55         [24]  333 	mov	_P0,#0x55
                                    334 ;	src/main.c:11: P1 = 0x0f;
      000066 75 90 0F         [24]  335 	mov	_P1,#0x0f
                                    336 ;	src/main.c:12: P3 =0x01;
      000069 75 B0 01         [24]  337 	mov	_P3,#0x01
                                    338 ;	src/main.c:13: TMOD = 0x01 ;
      00006C 75 89 01         [24]  339 	mov	_TMOD,#0x01
                                    340 ;	src/main.c:15: Delay();
      00006F 12 00 62         [24]  341 	lcall	_Delay
                                    342 ;	src/main.c:16: P2=0xf0 ;
